...
class SearchContributions extends Component {
    ...
    getCandidate = async (e) => {
        ...
        try {
          ...
          const results = await (await fetch (`https://api.open.fec.gov/v1/committee/${committeeId}/schedules/schedule_a/by_employer/?sort_hide_null=false&page=1&sort_nulls_last=false&cycle=2016&sort=-total&per_page=10&api_key=${process.env.REACT_APP_OPENFEC_KEY}&sort_null_only=false`)).json()
          this.setState({
            ...
            return (
              <div className='form-wrapper'>  
                <div className='chart-wrapper'>
                  <h3 className='search-form'>Search Contributions by Candidate</h3>
...
export default SearchContributions